<template>
  <div
    ...
    class="gan-h-screen gan-font-sans"
    :class="{ 'gan-dark': darkmode }"
  >
    <div
      class="gan-flex gan-flex-col gan-h-full gan-bg-neutral-100 dark:gan-bg-neutral-800"
    >
      <Header />
      <Content>
        ...
        <div
          v-if="!app.steps.length && app.empty.steps"
