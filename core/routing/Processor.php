...
namespace StaxWp\Gandalf\Core\Routing;
...
class Processor {
	...
	public function register_routes() {
		$routes = apply_filters( 'dollie_auth_routes', $this->routes );
		...
		if ( $routes_hash !== get_option( 'dollie_auth_routes_hash' ) ) {
			flush_rewrite_rules();
			update_option( 'dollie_auth_routes_hash', $routes_hash );
		}
	}
}
